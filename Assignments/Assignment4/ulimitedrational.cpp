...
// int main()
// {
//     UnlimitedInt *a = new UnlimitedInt(23);
//     UnlimitedInt *b = new UnlimitedInt(34);
//     UnlimitedInt *c = new UnlimitedInt(52);
//     UnlimitedInt *d = new UnlimitedInt(2);
//     UnlimitedRational *r1 = new UnlimitedRational(a, b);
//     UnlimitedRational *r2 = new UnlimitedRational(c, d);
//     cout << is_abs_big(b, c) << endl;
//     cout << a->get_size() << " " << a->get_sign() << " " << a->get_capacity() << " " << a->to_string() << endl;
//     cout << b->get_size() << " " << b->get_sign() << " " << b->get_capacity() << " " << b->to_string() << endl;
//     cout << c->get_size() << " " << c->get_sign() << " " << c->get_capacity() << " " << c->to_string() << endl;
//     cout << d->get_size() << " " << d->get_sign() << " " << d->get_capacity() << " " << d->to_string() << endl;

//     cout << r1->get_p_str() << " " << r1->get_q_str() << " " << r1->get_frac_str() << endl;
//     cout << r2->get_p_str() << " " << r2->get_q_str() << " " << r2->get_frac_str() << endl;

//     UnlimitedRational *added = UnlimitedRational::div(r1, r2);

//     cout << added->get_p_str() << " " << added->get_q_str() << " " << added->get_frac_str() << endl;
//     cout << r1->get_p_str() << " " << r1->get_q_str() << " " << r1->get_frac_str() << endl;
//     cout << r2->get_p_str() << " " << r2->get_q_str() << " " << r2->get_frac_str() << endl;
